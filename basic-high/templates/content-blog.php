	...
	<div class="container blog-container">
		...
		?>
       		...
       		<article  <?php post_class('post-content'); ?>>
				...
				<h2 class="post-title"><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title_attribute(); ?>"><?php  echo mb_strimwidth($title, 0, 30, '...'); ?></a></h2>
			...
			<?php
				...
				if ( $categories_list ):
			?>
					<span class="cat-links"><?php printf( __( '<span class="%1$s">Posted in</span> %2$s ', 'basic-high' ), 'entry-utility-prep entry-utility-prep-cat-links', $categories_list );$show_sep = true; ?></span>
