	...
	<div class="container page-container">
		...
		<div class="page-meta" role="header"><h1 class="page-title"> <?php  get_the_title(); ?> </h1></div> 
			...
			<section class="form-section">
				...
				const high_form = document.getElementById('high_contact'); 
				const high_name = document.getElementById('high_name'); 
				const high_email = document.getElementById('high_email');  
				const high_reason = document.getElementById('high_reason');
				const high_subject = document.getElementById('high_subject');
				const high_message = document.getElementById('high_message');
				const high_term = document.getElementById('high_term');      
				const submit_button = document.getElementById('high_submit'); 
				...
				function high_thanks(){
					
					high_contact.style.display = 'none';
